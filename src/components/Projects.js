      ...
      <div className="projects-content">
        ...
        <div className="project">
          ...
          <p>
            <ul className="proj">
              <li>
                Conducted research in Spectral Graph Theory under the
                supervision of Professor Sebastian Cioaba.
              </li>
              <li>
              ...
              <li>
                Utilized algorithmic techniques to improve the lower bounds of
                the independence number of known LPS graphs.
              </li>
              <li>
              ...
              <li>
                Investigated disconnecting vertex sets in distance regular
                graphs. Contributed to the establishment of a lower boundary for
