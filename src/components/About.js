          ...
          {isOpen1 && (
            <div className="collapsible-content">
              <p>
                ...
                billiards. In Spring of 2021, I joined Professor Christopher Cox
                on his research project on No-Slip Billiards. The main goal of
                the research followed from the ideas from the research paper
                No-Slip Billiards in Dimension Two by C. Cox and R. Reres. The
                paper provides results on periodicity of an infinite wedge and
                strip, and the persistently periodic equilateral triangle for
                particles with uniform mass distribution. We sought to
                generalize these results for a general mass distribution and
                investigate other geometric shapes of billiards tables. I
                developed Python scripts to conduct numerical simulations for a
                particle with variable mass distribution, launched on tables of
                various geometric shapes. I created phase portraits by plotting
                the final phases of multiple particles after a certain amount of
                collisions with the boundary to numerically analyze the behavior
                of the dynamical system with a fixed table shape and a fixed
                mass distribution of a particle. For a regular polygon shaped
                ...
                the paper. In Summer of 2022, I joined Professor Sebastian
                Cioaba on his research project on the LPS Ramanujan graphs. Our
                research mainly followed the book Elementary Number Theory,
                Group Theory, and Ramanujan Graphs by G. Davidoff, P. Sarnak and
                A. Valette. Our goal was to investigate the independence number
                of the LPS Ramanujan graphs family. We followed the entire book
                to understand the construction of this graph. We hoped that
                ...
                graphs. In Summer of 2023, I continued my research working under
                the supervision of Professor Sebastian Cioaba on the problem of
                the minimum vertex disconnecting set of distance regular graphs.
                Our goal was to either prove or disprove Brouwer's conjecture on
                the least disconnecting vertex set for distance regular graphs.
                With guidance I was able to prove that the conjecture is true
                for a specific family of distance regular graphs namely the
                Hamming graph. My interests took a turn in senior year when I
                joined a directed reading program where I was paired up with a
                graduate student to read the book Introduction to Probability
                Models by S. Ross. More specifically I focused on reading the
                chapters on Markov Chains and Continuous-Time Markov Chains.
                Reading these chapters on Markov Chains piqued my interest in
                this specific field. I recently got accepted to a Winter 2024
                undergraduate research program at the University of Delaware
                that will allow me to do more research in this field of
                probability under the guidance of Professor Naya Banerjee. In
                addition to research, I have held various teaching and tutoring
                positions, gaining valuable experience in conveying complex
                mathematical concepts to students at different levels. As a
                tutor at the Mathematical Sciences Learning Lab, I provided
          ...
          {isOpen2 && (
            <div className="collapsible-content">
              <p>
                ...
                any academic community. As a computer science lab assistant, I
                expanded my academic engagement by collaborating closely with
                professors from the Department of Computer Science and assisting
                students with complex computer science concepts. Assisting
                students with troubleshooting and debugging their code, enhanced
                my own proficiency in coding. Through this experience I learned
                to communicate effectively with professors and my peers. As
                co-founder and co-president of the Competitive Programming Club
                at the University of Delaware, I cultivated a dynamic community
                for students to enhance problem-solving skills through
                ...
                creating a lasting legacy. I am enthusiastic about applying
                these experiences to contribute to an intellectual community
                that values diverse backgrounds. With a background in
                mathematical research, tutoring, grading, lab assistance, and
                serving as co-president of the Competitive Programming Club, I
                have developed a passion for fostering inclusivity, equity, and
                a sense of belonging within academic spaces. I look forward to
                advancing these principles and actively participating in
                initiatives that prioritize diverse voices.
              </p>
            </div>
          )}
        </div>
